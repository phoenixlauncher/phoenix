...
struct EditGameView: View {
    ...
    var body: some View {
        ScrollView {
            Text("Editing \(currentGame.name). Only enter information in the fields you wish to change")
                .fontWeight(.bold)
                .padding()
            ...
            VStack(alignment: .leading) {
                ...
                HStack {
                    ...
                    Text("Not required. This is mostly just for sorting purposes in the sidebar. If you do not select a platform the game will still work, it will just go under the 'Other' header")
                        .frame(width: 300)
                }
                ...
                HStack {
                    ...
                    TextField("Enter terminal command to launch game", text: $cmdInput)
                        .padding()
                    Text("Not required. If no command is entered, the game will show up in the sidebar, but the play button will not do anything")
                        .frame(width: 300)
                }
                ...
                .fileImporter(
                    ...
                    do {
                        let selectedFile: URL = try result.get().first ?? URL(fileURLWithPath: "test")
