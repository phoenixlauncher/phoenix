          ...
          do {
            ...
            if iconInput.hasSuffix(".jpg") || iconInput.hasSuffix(".jpeg") {
              url = url.appendingPathComponent(
                "Phoenix/cachedImages/\(currentGame.name)_icon.jpg", conformingTo: .jpeg)
            } else if iconInput.hasSuffix(".png") {
              url = url.appendingPathComponent(
                "Phoenix/cachedImages/\(currentGame.name)_icon.png", conformingTo: .png)
            }
        ...
        .fileImporter(
          ...
          do {
            ...
            if headInput.hasSuffix(".jpg") || headInput.hasSuffix(".jpeg") {
              url = url.appendingPathComponent(
                "Phoenix/cachedImages/\(currentGame.name)_header.jpg", conformingTo: .jpeg)
            } else if headInput.hasSuffix(".png") {
              url = url.appendingPathComponent(
                "Phoenix/cachedImages/\(currentGame.name)_header.png", conformingTo: .png)
            }
